...
- <a name="_mvfafa4v44hl"></a>**Vies d'evacuació:**\
  ...
  - **Botons d'Apagat d'Emergència (EPO):** Es col·locaran botons EPO (Emergency Power Off) estratègicament a prop de les sortides, permetent tallar tota l'alimentació elèctrica del CPD en una emergència crítica, per exemple, en cas d'incendi o inundació per risc elèctric.![](/Imatges/plandeevacuacion.png)
